...
SRCS =			$(addprefix src/, \
				...
				$(addprefix parsing/, dollars.c dollars2.c dollars3.c dollars4.c dollars5.c list.c quote.c redirection.c redirection_utils.c split.c syntax_error.c syntax_error2.c syntax_error3.c syntax_utils.c token.c) \
				free.c \
				signal.c \
				main.c)
